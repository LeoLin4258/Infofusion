...
export const Content = () => {
  ...
  return (
    <div className="h-full lg:px-6">
      <div className="flex gap-2 w-full justify-center items-center mt-20 text-4xl font-semibold">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 2xl:grid-cols-3 gap-5  justify-center w-full">
              {features.map((feature, index) => (
                <Card key={index} className={` rounded-xl shadow-md px-3 w-full min-h-40 bg-${feature.cardColor}`}>
            ...
            <Table aria-label="Example static collection table">
              ...
              <TableBody>
                ...
                <TableRow key="3">
                  ...
                  <TableCell> <Link isExternal showAnchorIcon href="https://github.com/LeoLin4258/Infofusion">Infofusion</Link></TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </div>
